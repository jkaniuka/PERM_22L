...
yline(941,'--r', 941)
ylim([0 1600]);
xlabel('Numer dyskretnej chwili czasu [k]');
ylabel('Wartość dominującej częstotliwości [Hz]');
title('Sygnał po przetworzeniu');

% Dodaję do poniższych wektorów wartości dominujących częstotliwości
...
division_threshold = 1025; % arbitralna granica wspomnianego podziału
